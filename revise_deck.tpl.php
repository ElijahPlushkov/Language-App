        ...
        <div class="card-body text-center">
            ...
            <div class="card-back d-none">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button class="btn btn-success increase-success-rate">Yes:)</button>
                    <button class="btn btn-danger decrease-success-rate">No:(</button>
                </div>
            </div>
...
<div class="display-final-score d-flex flex-column align-items-center justify-content-center d-none">
    <p>Final score: <span class="final-score-display"></span></p>
    <p>Deck's success rate is <span class="success-rate-display"></span></p>
    <p>Comment: <span class="comment"></span></p>
</div>

<!--Finish and Restart buttons-->
<div id="deck-data" data-deck-id="<?= $deck['deck_id'] ?>"></div>
